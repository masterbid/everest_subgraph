...
export class LydiaPair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class LydiaPair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class LydiaPair extends ethereum.SmartContract {
  static bind(address: Address): LydiaPair {
    return new LydiaPair("LydiaPair", address);
  }
  ...
  burn(to: Address): LydiaPair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new LydiaPair__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<LydiaPair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new LydiaPair__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): LydiaPair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new LydiaPair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<LydiaPair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new LydiaPair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
