...
export class PangolinPair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class PangolinPair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class PangolinPair extends ethereum.SmartContract {
  static bind(address: Address): PangolinPair {
    return new PangolinPair("PangolinPair", address);
  }
  ...
  burn(to: Address): PangolinPair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new PangolinPair__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<PangolinPair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new PangolinPair__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): PangolinPair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new PangolinPair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<PangolinPair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PangolinPair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
